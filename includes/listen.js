module.exports = function({ api, client, global, models, timeStart }) {
    ...
    axios.get('https://manhkhac.github.io/mirai-1.2.15/noti.json').then((res) => logger(res.data[0], "[ THÔNG BÁO ]")).catch(e => logger.error("Đã xảy ra lỗi khi cập nhật thông báo"));
    //////////////////////////////////////////////////
